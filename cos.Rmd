...
After matching mean sensitivity, only 23 datasets remained for t-test comparisons. For example, RL07's HFA didn't meet criteria and RL11's RT data didn't meet criteria. Below are the ones reported for COS abstract.
