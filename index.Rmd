...
Bland–Altman analysis for mean deviation comparing HFA and Retinalogik. The red solid line indicates the mean bias, the black dashed lines indicate the 95% limits of agreement, the blue solid line indicates the regression line and the black solid line indicates y = 0.
...
print(meanvariability)

hfaplot <- meanvariability %>% 
  ggplot(aes(x, y, meanHFA)) +
  geom_raster(aes(x = x, y = y, fill = meanHFA)) +
  geom_text(aes(label = paste0(round(meanHFA, 2), "\n(", round(sdHFA, 2), ")"), x = x, y = y)) +
  coord_fixed(ratio = 1) +
  scale_fill_gradientn(colours = viridis(47), limits = c(-1, 46),
                       na.value="darkred") +
  theme_bw() +
...
rtplot <- meanvariability %>%
  ...
  geom_text(aes(label = paste0(round(meanRT, 2), "\n(", round(sdRT, 2), ")"), x = x, y = y)) +
  coord_fixed(ratio = 1) +
  scale_fill_gradientn(colours = viridis(47), limits = c(-1, 46),
                       na.value="darkred") +
  theme_bw() +
...
diffplot <- meanvariability %>%
  ...
  geom_text(aes(label = paste0(round(meanDiff, 2), "\n(", round(sdDiff, 2), ")"), x = x, y = y)) +
  coord_fixed(ratio = 1) +
